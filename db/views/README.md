...
một view chỉ-đọc, và tài khoản CSDL dùng để thực thi truy vấn chỉ được `GRANT SELECT` trên view đó.
...
2. Tạo tài khoản CSDL chỉ-đọc riêng cho trợ lý AI và `GRANT SELECT` trên đúng ba view.
