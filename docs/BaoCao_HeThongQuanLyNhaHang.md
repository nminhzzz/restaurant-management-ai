...
![](./media/image1.png){width="1.4583333333333333in" height="1.5729166666666667in"}
...
+-----------------------------------+-----------------------------------+
| Họ và tên : Lê Nam Khánh          | Giới tính :                       |
|                                   |                                   |
| Ngày sinh :                       | Nơi sinh :                        |
|                                   |                                   |
...
| Lớp hành chính :                  |                                   |
+-----------------------------------+-----------------------------------+
| Họ và tên : Nguyễn Mạnh Hùng      | Giới tính :                       |
|                                   |                                   |
| Ngày sinh :                       | Nơi sinh :                        |
|                                   |                                   |
| Chuyên ngành : Công nghệ phần mềm | Mã SV :                           |
...
| Lớp hành chính :                  |                                   |
+-----------------------------------+-----------------------------------+
| Họ và tên : Lê Nho Minh           | Giới tính :                       |
|                                   |                                   |
| Ngày sinh :                       | Nơi sinh :                        |
|                                   |                                   |
| Chuyên ngành : Công nghệ phần mềm | Mã SV :                           |
...
[CHƯƠNG 1: KHẢO SÁT HỆ THỐNG](#chương-1-khảo-sát-hệ-thống)

[1.1. Giới thiệu chung](#giới-thiệu-chung)

[1.2. Mục đích đề tài](#mục-đích-đề-tài)

[1.3. Mục tiêu đề tài](#mục-tiêu-đề-tài)

[1.3.1. Mục tiêu tổng quát](#mục-tiêu-tổng-quát)

[1.3.2. Mục tiêu cụ thể](#mục-tiêu-cụ-thể)

[1.4. Phạm vi đề tài](#phạm-vi-đề-tài)

[1.4.1. Phạm vi nghiệp vụ](#phạm-vi-nghiệp-vụ)

[1.4.2. Phạm vi công nghệ](#phạm-vi-công-nghệ)

[1.4.3. Giới hạn của đề tài](#giới-hạn-của-đề-tài)

[1.5. Phân công thực hiện](#phân-công-thực-hiện)

[1.6. Phân tích đối thủ cạnh tranh](#phân-tích-đối-thủ-cạnh-tranh)

[1.6.1. Khảo sát và đánh giá chung](#khảo-sát-và-đánh-giá-chung)

[1.6.2. Phân tích chi tiết các đối thủ](#phân-tích-chi-tiết-các-đối-thủ)

[1.6.3. Đề xuất giải pháp và định hướng phát triển](#đề-xuất-giải-pháp-và-định-hướng-phát-triển)

[1.7. Khảo sát người dùng](#khảo-sát-người-dùng)

[1.7.1. Mục đích khảo sát](#mục-đích-khảo-sát)

[1.7.2. Phương pháp khảo sát](#phương-pháp-khảo-sát)

[1.7.3. Câu hỏi khảo sát](#câu-hỏi-khảo-sát)

[1.7.4. Kết quả và phân tích kết quả khảo sát](#kết-quả-và-phân-tích-kết-quả-khảo-sát)

[1.8. Quy trình nghiệp vụ](#quy-trình-nghiệp-vụ)

[1.9. Xác định yêu cầu](#xác-định-yêu-cầu)

[1.9.1. Yêu cầu chức năng](#yêu-cầu-chức-năng)

[1.9.2. Yêu cầu phi chức năng](#yêu-cầu-phi-chức-năng)

[1.10. Xác định đối tượng sử dụng hệ thống](#xác-định-đối-tượng-sử-dụng-hệ-thống)

[CHƯƠNG 2: PHÂN TÍCH HỆ THỐNG](#chương-2-phân-tích-hệ-thống)

[2.1. Mô hình hóa chức năng nghiệp vụ](#mô-hình-hóa-chức-năng-nghiệp-vụ)

[2.1.1. Xác định và gom nhóm chức năng](#xác-định-và-gom-nhóm-chức-năng)

[2.1.2. Sơ đồ phân rã chức năng (BFD)](#sơ-đồ-phân-rã-chức-năng-bfd)

[2.1.3. Sơ đồ Use Case](#sơ-đồ-use-case)

[2.2. Mô hình hóa tiến trình nghiệp vụ](#mô-hình-hóa-tiến-trình-nghiệp-vụ)

[2.2.1. Ký hiệu sử dụng](#ký-hiệu-sử-dụng)

[2.2.2. Sơ đồ luồng dữ liệu (DFD) mức ngữ cảnh](#sơ-đồ-luồng-dữ-liệu-dfd-mức-ngữ-cảnh)

[2.2.3. DFD mức đỉnh (DFD1)](#dfd-mức-đỉnh-dfd1)

[2.2.4. DFD mức dưới đỉnh (DFD2)](#dfd-mức-dưới-đỉnh-dfd2)

[2.2.5. Sơ đồ tuần tự (Sequence Diagram)](#sơ-đồ-tuần-tự-sequence-diagram)

[2.3. Đặc tả chức năng](#đặc-tả-chức-năng)

[2.3.1. Module 1 --- Quản lý danh mục](#module-1-quản-lý-danh-mục)

[2.3.2. Module 2 --- Quản lý bán hàng](#module-2-quản-lý-bán-hàng)

[2.3.3. Module 3 --- Quản lý kho](#module-3-quản-lý-kho)

[2.3.4. Module 4 --- Báo cáo thống kê](#module-4-báo-cáo-thống-kê)

[2.3.5. Module 5 --- Cài đặt hệ thống](#module-5-cài-đặt-hệ-thống)

[2.3.6. Module 6 --- AI Assistant](#module-6-ai-assistant)

[CHƯƠNG 3: THIẾT KẾ HỆ THỐNG](#chương-3-thiết-kế-hệ-thống)

[3.1. Thiết kế kiến trúc hệ thống](#thiết-kế-kiến-trúc-hệ-thống)

[3.1.1. Kiến trúc tổng thể](#kiến-trúc-tổng-thể)

[3.1.2. Kiến trúc phần mềm](#kiến-trúc-phần-mềm)

[3.2. Thiết kế cơ sở dữ liệu](#thiết-kế-cơ-sở-dữ-liệu)

[3.2.1. Xác định tập thực thể và thuộc tính](#xác-định-tập-thực-thể-và-thuộc-tính)

[3.2.2. Mô hình thực thể liên kết](#mô-hình-thực-thể-liên-kết)

[3.2.3. Chiến lược Index](#chiến-lược-index)

[3.3. Thiết kế giao diện](#thiết-kế-giao-diện)

[3.4. Thiết kế kiểm soát](#thiết-kế-kiểm-soát)

[3.4.1. Phân định quyền hạn về dữ liệu](#phân-định-quyền-hạn-về-dữ-liệu)

[3.4.2. Phân định quyền hạn về chức năng](#phân-định-quyền-hạn-về-chức-năng)

[3.4.3. Phân định trách nhiệm và thẩm quyền theo từng vai trò](#phân-định-trách-nhiệm-và-thẩm-quyền-theo-từng-vai-trò)

[CHƯƠNG 4: TRIỂN KHAI XÂY DỰNG CHƯƠNG TRÌNH](#chương-4-triển-khai-xây-dựng-chương-trình)

[4.1. Công nghệ sử dụng](#công-nghệ-sử-dụng)

[4.1.1. Giới thiệu lý do sử dụng (Công nghệ/framework)](#giới-thiệu-lý-do-sử-dụng-công-nghệframework)

[4.1.2. Giới thiệu lý do sử dụng (Database)](#giới-thiệu-lý-do-sử-dụng-database)

[4.2. Kết quả thực hiện](#kết-quả-thực-hiện)
...
[*Bảng 1. Danh sách thực thể của hệ thống* 41](#B%25E1%25BA%25A3ng!0|sequence)

[*Bảng 2. Thuộc tính của thực thể VAI_TRO* 42](#B%25E1%25BA%25A3ng!1|sequence)

[*Bảng 3. Thuộc tính của thực thể NGUOI_DUNG* 42](#B%25E1%25BA%25A3ng!2|sequence)

[*Bảng 4. Thuộc tính của thực thể CAU_HINH_HE_THONG* 43](#B%25E1%25BA%25A3ng!3|sequence)

[*Bảng 5. Thuộc tính của thực thể NHAT_KY_HE_THONG* 43](#B%25E1%25BA%25A3ng!4|sequence)

[*Bảng 6. Thuộc tính của thực thể NHOM_MON* 44](#B%25E1%25BA%25A3ng!5|sequence)

[*Bảng 7. Thuộc tính của thực thể MON_AN* 45](#B%25E1%25BA%25A3ng!6|sequence)

[*Bảng 8. Thuộc tính của thực thể LICH_SU_GIA_MON* 45](#B%25E1%25BA%25A3ng!7|sequence)

[*Bảng 9. Thuộc tính của thực thể CONG_THUC* 46](#B%25E1%25BA%25A3ng!8|sequence)

[*Bảng 10. Thuộc tính của thực thể CHI_TIET_CONG_THUC* 46](#B%25E1%25BA%25A3ng!9|sequence)

[*Bảng 11. Thuộc tính của thực thể NGUYEN_LIEU* 47](#B%25E1%25BA%25A3ng!10|sequence)

[*Bảng 12. Thuộc tính của thực thể NHA_CUNG_CAP* 48](#B%25E1%25BA%25A3ng!11|sequence)

[*Bảng 13. Thuộc tính của thực thể BAN* 49](#B%25E1%25BA%25A3ng!12|sequence)

[*Bảng 14. Thuộc tính của thực thể ORDER* 49](#B%25E1%25BA%25A3ng!13|sequence)

[*Bảng 15. Thuộc tính của thực thể CHI_TIET_ORDER* 50](#B%25E1%25BA%25A3ng!14|sequence)

[*Bảng 16. Thuộc tính của thực thể LICH_SU_DOI_BAN* 51](#B%25E1%25BA%25A3ng!15|sequence)

[*Bảng 17. Thuộc tính của thực thể HOA_DON* 52](#B%25E1%25BA%25A3ng!16|sequence)

[*Bảng 18. Thuộc tính của thực thể GIAO_DICH_THANH_TOAN* 52](#B%25E1%25BA%25A3ng!17|sequence)

[*Bảng 19. Thuộc tính của thực thể PHIEU_BEP* 53](#B%25E1%25BA%25A3ng!18|sequence)

[*Bảng 20. Thuộc tính của thực thể PHIEU_NHAP_KHO* 53](#B%25E1%25BA%25A3ng!19|sequence)

[*Bảng 21. Thuộc tính của thực thể CHI_TIET_PHIEU_NHAP* 54](#B%25E1%25BA%25A3ng!20|sequence)

[*Bảng 22. Thuộc tính của thực thể LO_NGUYEN_LIEU* 55](#B%25E1%25BA%25A3ng!21|sequence)

[*Bảng 23. Thuộc tính của thực thể PHIEU_XUAT_KHO* 56](#B%25E1%25BA%25A3ng!22|sequence)

[*Bảng 24. Thuộc tính của thực thể CHI_TIET_PHIEU_XUAT* 56](#B%25E1%25BA%25A3ng!23|sequence)

[*Bảng 25. Thuộc tính của thực thể PHIEU_KIEM_KE* 57](#B%25E1%25BA%25A3ng!24|sequence)

[*Bảng 26. Thuộc tính của thực thể CHI_TIET_KIEM_KE* 57](#B%25E1%25BA%25A3ng!25|sequence)

[*Bảng 27. Thuộc tính của thực thể GIAO_DICH_KHO* 59](#B%25E1%25BA%25A3ng!26|sequence)

[*Bảng 28. Thuộc tính của thực thể GIA_BINH_QUAN_THANG* 59](#B%25E1%25BA%25A3ng!27|sequence)

[*Bảng 29. Thuộc tính của thực thể PHIEN_CHAT_AI* 60](#B%25E1%25BA%25A3ng!28|sequence)

[*Bảng 30. Thuộc tính của thực thể TRUY_VAN_AI* 61](#B%25E1%25BA%25A3ng!29|sequence)

[*Bảng 31. Các mối quan hệ chính giữa các thực thể* 63](#B%25E1%25BA%25A3ng!30|sequence)

[Bảng 32. Ma trận quyền hạn theo dữ liệu và vai trò 65](#B%25E1%25BA%25A3ng!31|sequence)

**DANH MỤC HÌNH ẢNH**

[*Hình 1. Sơ đồ phân rã chức năng (BFD) của hệ thống* 28](#H%25C3%25ACnh!0|sequence)

[*Hình 2. Mô hình thực thể liên kết (ERD) của hệ thống* 63](#H%25C3%25ACnh!1|sequence)
...
-   C1. Quán chấp nhận những hình thức thanh toán nào (tiền mặt, chuyển khoản, QR...)? Hình thức nào phổ biến nhất?

-   C2. Với thanh toán chuyển khoản/QR, quán xác nhận đã nhận được tiền bằng cách nào? Có từng gặp tình huống khách nói đã chuyển nhưng quán chưa nhận được không?
...
-   Khi khách yêu cầu thanh toán, thu ngân chọn hình thức (tiền mặt, chuyển khoản, hoặc QR); với QR, hệ thống tạo mã động và chờ xác nhận qua webhook trong tối đa 10 phút (FR-SALE-15).
...
![](./media/image2.png){width="6.457638888888889in" height="1.761111111111111in"}

*Hình* *. Sơ đồ phân rã chức năng (BFD) của hệ thống*
...
![](./media/image3.png){width="6.083333333333333in" height="4.427515310586177in"}

*Hình* *2. SD-01 --- Đăng nhập và phân quyền theo vai trò*

![](./media/image4.png){width="6.091666666666667in" height="4.5201060804899384in"}

*Hình* *3. SD-02 --- Lập và gửi order xuống bếp*

![](./media/image5.png){width="6.016666666666667in" height="4.553152887139108in"}

*Hình* *4. SD-03 --- Thanh toán bằng mã QR và phát hành hóa đơn*

![](./media/image6.png){width="6.0in" height="4.275184820647419in"}

*Hình* *5. SD-04 --- Nhập kho và tạo lô nguyên liệu*

![](./media/image7.png){width="6.058333333333334in" height="4.406060804899387in"}
...
*Bảng* *. Danh sách thực thể của hệ thống*
...
*Bảng* *. Thuộc tính của thực thể VAI_TRO*
...
*Bảng* *. Thuộc tính của thực thể NGUOI_DUNG*
...
*Bảng* *. Thuộc tính của thực thể CAU_HINH_HE_THONG*
...
*Bảng* *. Thuộc tính của thực thể NHAT_KY_HE_THONG*
...
*Bảng* *. Thuộc tính của thực thể NHOM_MON*
...
*Bảng* *. Thuộc tính của thực thể MON_AN*
...
*Bảng* *. Thuộc tính của thực thể LICH_SU_GIA_MON*
...
*Bảng* *. Thuộc tính của thực thể CONG_THUC*
...
*Bảng* *. Thuộc tính của thực thể CHI_TIET_CONG_THUC*
...
*Bảng* *. Thuộc tính của thực thể NGUYEN_LIEU*
...
*Bảng* *. Thuộc tính của thực thể NHA_CUNG_CAP*
...
*Bảng* *. Thuộc tính của thực thể BAN*
...
*Bảng* *. Thuộc tính của thực thể ORDER*
...
*Bảng* *. Thuộc tính của thực thể CHI_TIET_ORDER*
...
*Bảng* *. Thuộc tính của thực thể LICH_SU_DOI_BAN*
...
*Bảng* *. Thuộc tính của thực thể HOA_DON*
...
*Bảng* *. Thuộc tính của thực thể GIAO_DICH_THANH_TOAN*
...
*Bảng* *. Thuộc tính của thực thể PHIEU_BEP*
...
*Bảng* *. Thuộc tính của thực thể PHIEU_NHAP_KHO*
...
*Bảng* *. Thuộc tính của thực thể CHI_TIET_PHIEU_NHAP*
...
*Bảng* *. Thuộc tính của thực thể LO_NGUYEN_LIEU*
...
*Bảng* *. Thuộc tính của thực thể PHIEU_XUAT_KHO*
...
*Bảng* *. Thuộc tính của thực thể CHI_TIET_PHIEU_XUAT*
...
*Bảng* *. Thuộc tính của thực thể PHIEU_KIEM_KE*
...
*Bảng* *. Thuộc tính của thực thể CHI_TIET_KIEM_KE*
...
*Bảng* *. Thuộc tính của thực thể GIAO_DICH_KHO*
...
*Bảng* *. Thuộc tính của thực thể GIA_BINH_QUAN_THANG*
...
*Bảng* *. Thuộc tính của thực thể PHIEN_CHAT_AI*
...
*Bảng* *. Thuộc tính của thực thể TRUY_VAN_AI*
...
*Bảng* *. Các mối quan hệ chính giữa các thực thể*
...
*Hình* *. Mô hình thực thể liên kết (ERD) của hệ thống*
...
Bảng . Ma trận quyền hạn theo dữ liệu và vai trò
  ...
  Order, hóa đơn, thanh toán                                 Toàn quyền, mọi chi nhánh   CRUD trên order/hóa đơn đang xử lý      Không truy cập
